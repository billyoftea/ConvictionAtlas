...
from conviction_atlas_backend.fund_engine.managers import MANAGERS, run_manager
from conviction_atlas_backend.paths import (
    LOG_DIR,
    ORDER_DIR,
    ensure_directories,
    openclaw_candidates,
...
def daily_run(dry_run=False):
    ...
    for mgr_id in MANAGERS:
        ...
        # Save order log
        if orders_placed:
            order_path = ORDER_DIR / f"{today}_{mgr_id}_orders.json"
