...
"""
from conviction_atlas_backend.fund_engine.llm_engine import llm_call
import json
...
MANAGERS = {
    "manager_1_trend":      {"system": MANAGER_I_SYSTEM,   "emoji": "M1", "label": "Manager I - Trend"},
    "manager_2_defi":       {"system": MANAGER_II_SYSTEM,  "emoji": "M2", "label": "Manager II - DeFi"},
    "manager_3_quant":      {"system": MANAGER_III_SYSTEM, "emoji": "M3", "label": "Manager III - Quant"},
    "manager_4_tron":       {"system": MANAGER_IV_SYSTEM,  "emoji": "M4", "label": "Manager IV - TRON"},
}
...
if __name__ == "__main__":
    # Test single manager
    from conviction_atlas_backend.fund_engine.market_data import collect_all
